...
Create a map that shows the madera roads layer and the `sjer` plot locations.  Use the `sjer_aoi` boundary (`sjer_crop.shp`) to crop your map. Recall using `extent()` to find the extent of a layer. 
