...
# your working directory is wherever this .Rmd is! No need to set it
...
Guidelines:
1. Keep your data files and this .Rmd in the same folder (you can change the name of it).
2. Keep chunks small (3-4 tasks max, generally) and oriented around a task (e.g. loading data, a single plot, etc.). 
3. Do not put install lines, View(), or paste whole data frames into an .Rmd code chunk as they will either break your knitted pdf, or make it 60 pages long. You can either do those things in the console directly, or comment them out before knitting. 
