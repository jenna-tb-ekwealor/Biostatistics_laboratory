...
[ Introduction
]{style="color:#66023C; font-size:150%; font-weight:600"}\
...
a.  *What is the class of the dataset "anole" (e.g., data frame, table,
    tibble)?*

b.  *How many observations and variables does the dataset "anole" have?*

c.  *What is the class of each variable in the dataset "anole" (e.g.,
...
b.  *What is the mean Femur length of "anole"?*

c.  *What are the first three variables in "anole"?*
...
[ **Stop, Think, Do:**
]{style="color:#66023C; font-size:100%; font-weight:600"} Now, it is
your turn to practice what we have done with dataset "lizards". **Stop**
...
]{style="color:#2724ed; font-size:150%; font-weight:600"}
