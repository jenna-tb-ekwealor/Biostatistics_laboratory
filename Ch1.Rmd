...
new script and save it. We are going to be doing this in an R Markdown "Lab Report" format. Go to File -\> New File -\> R Markdown. Choose 'From Template' on the left and select 'Lab Report {openintro}'. Once
opened, save it with a useful name in your working_directory folder, with a .Rmd file extension. For that, go to File -\> Save.
...
This activity was adapted from the [Biostatistics using R: A Laboratory Manual](https://qubeshub.org/publications/2213/supportingdocs/1) by Raisa Hernández-Pacheco and Alexis A Diaz of California State University, Long Beach.
