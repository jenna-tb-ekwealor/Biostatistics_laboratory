<p style="text-align: center;">[Synthetic phylogenetic trees]{style="font-size:250%; font-weight:400"}</p>
...
The synthetic Open Tree of Life (**synthetic OpenTree** from now on) summarizes information from trees from peer-reviewed and published studies that have been uploaded to the OpenTree database (the Phylesystem) through a <a href="https://tree.opentreeoflife.org/curator" target="_blank">curator system</a>.
...
``` r
# retrieve the felis ott id
felis_ott_id <- resolved_names %>% dplyr::filter(unique_name == "Felis") %>% select(ott_id)
felis_ott_id

# use the felis ott id to build a subtree
felis_subtree <- rotl::tol_subtree(felis_ott_id$ott_id)
ape::plot.phylo(felis_subtree)
```
...
This lab activity was originally written by Luna L. Sanchez Reyes and Emily Jane McTavish (see <a href="https://github.com/McTavishLab/R_OpenTree_tutorials/tree/gh-pages" target="_blank">https://github.com/McTavishLab/R_OpenTree_tutorials/tree/gh-pages</a>) and modified by Jenna Ekwealor. 

**Open Tree of Life** aims to construct a comprehensive, dynamic and digitally-available tree of life by synthesizing published phylogenetic trees along with taxonomic data. The project is a collaborative effort between 11 PIs across 10 institutions. Funded by NSF ABI #1759838, NSF AVAToL #1208809. More information and tutorials at <a href="https://opentreeoflife.github.io" target="_blank">opentreeoflife.org</a>.
